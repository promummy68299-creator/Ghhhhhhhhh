...
BOT_TOKEN = '8831139428:AAHdeA2M8wGN184Usulp_QFbyHlHN83yR7M'           # from @BotFather
API_URL = 'https://linkvio.gt.tc'           # your domain (no trailing slash)
# ===========================================

API_KEY = 'f8a7d9e3c4b2a1f6e5d4c3b2a1f6e5d4c3b2a1f6e5d4c3b2a1f6e5d4c3b2a1'
FORCE_JOIN_CHANNEL = ''   # optional: '@my_channel' – leave empty to disable
...
def api_call(endpoint, method='GET', payload=None, params=None):
    """Generic API caller – works for all endpoints."""
...
def help_cmd(msg):
    text = (
        ...
        "/stats <shortcode> – show details of a specific link\n\n"
...
def stats_cmd(msg):
    ...
    # If specific shortcode requested (not yet implemented but we can show all user links)
    # For now, show user's own links
