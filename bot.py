...
BOT_TOKEN = '8831139428:AAFYSx8iZ1dImXRfn15PFLSEOB0nC-H2MH8'           # ⚠️ CHANGE THIS
...
if __name__ == '__main__':
    logger.info("Bot starting (single‑threaded mode)")
    try:
        # threaded=False avoids extra threads – good for shared hosting
        bot.infinity_polling(timeout=60, long_polling_timeout=60, threaded=False)
    except Exception as e:
